...
<div style="padding: 20px; margin-top:30px">
	...
	<div id="actions" class="row">
		<div class="col-md-12"
			style="padding-left: 20px; display: flex;flex-direction: row;justify-content: center; align-items: center;">
			<a href="#" class="btn btn-dark" style="width: 500px; padding-left: 20px; background-color:  #0ACCA7"
				data-bs-toggle="modal" data-bs-target="#concluir-agendamento-modal"
				data-concluir="<?php echo $agendamento['id']; ?>"><i class="fa-solid fa-circle-check"></i> Concluir
				atendimento</a>
			<a href="<?php echo BASEURL; ?>empresas/index.php" class="btn btn-default" style="width: 500px"><i
